...
public class CamaraMovement : MonoBehaviour
{
    ...
    private Vector3 CamPosition_4 = new Vector3(110.7837f, 37.08178f, 151.1788f);
    private Quaternion CamRotation_4 = Quaternion.Euler(45.242f, -148.973f, -0.027f);
    ...
    private float PlayerLimitZ_4 = 135f;
    private float PlayerLimitX_4 = 70f;
    ...
    void Update()
    {
        ...
        if (PlayerPosition.position.z <= PlayerLimitZ_4 && PlayerPosition.position.x >= PlayerLimitX_4)
        {
            transform.position = CamPosition_4;
            transform.rotation = CamRotation_4;
        }
